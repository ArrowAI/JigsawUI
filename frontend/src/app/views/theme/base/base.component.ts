...
// Layout
import { LayoutConfigService, MenuConfigService, PageConfigService, SubheaderService } from '../../../core/_base/layout';
...
export class BaseComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		private subhederService: SubheaderService,
	...
	ngOnInit(): void {
		...
		const subheaderSbus = this.subhederService.disabled$.subscribe(data => {
			console.log(data);
			this.subheaderDisplay = !data;
		})
		this.unsubscribe.push(subheaderSbus);
